          ...
          >
            ...
            <VStack className="flex-1 px-4 py-10 items-center justify-center gap-6">
              ...
              <View style={{ boxShadow: "0px 4px 4px 0px #00000025" }} className={"w-4/5"}>
                ...
                >
                  <Button onPress={() => handleRedirect("TrackWars")} className="text-rythmix-dark bg-transparent justify-center items-center h-full uppercase font-black">
            ...
            >
              <VStack className="flex-1 px-4 py-10 items-center justify-center gap-6">
                ...
                <View style={{ boxShadow: "0px 4px 4px 0px #00000025" }} className={"w-4/5"}>
                  ...
                  >
                    <Button onPress={() => handleRedirect("BlindRythm")} className="text-rythmix-dark bg-transparent justify-center items-center h-full uppercase font-black">
                      <ButtonText className="uppercase text-4xl font-black">Start</ButtonText>
                    </Button>
                  </LinearGradient>
                </View>
