                    ...
                    <VStack space="xl" className="w-full">
                        <FormControl>
                            ...
                            <Input className="border-[6px] text-rythmix-white border-white rounded-none h-[68px]">
                                <InputField className={"text-rythmix-white"} placeholder="johndoe@gmail.com" value={userInfo.email} onChangeText={(e)=>setUserInfo((prevUser)=>({...prevUser,email:e}))}></InputField>
                            </Input>
                        </FormControl>
                        <FormControl>
                            <FormControlLabel>
                        ...
                        <View style={{ boxShadow: "0px 4px 4px 0px #00000025" }} >
                            ...
                            >
                                <Button onPress={logIn} className="text-rythmix-dark bg-transparent justify-center items-center h-full uppercase font-black">
